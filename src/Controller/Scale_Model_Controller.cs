...
namespace ScaleService.Controller
{
    public class Scale_Controllers
    {
        ...
        private List<Scale_Result> Create_Response(string status,string ScaleWeight,string message)
        {
        ...
        public List<Scale_Result> Get_Weight(string Scale_Model)
        {
            ...
            return Create_Response("Error", "-1", "No match Scale found");
        }
        public List<Scale_Result> Brecknell_335()
        {
            ...
            if (BreckNell_335.data_recieved)
                return Create_Response("Success", Scale_Weight, "Success");
            return Create_Response("Error", "-1", "data has not yet recived");
